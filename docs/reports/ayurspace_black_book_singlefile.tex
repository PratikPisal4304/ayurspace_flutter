...
%=============================================================
%  FRONT MATTER — Title · Certificate · Approval · Declaration
%=============================================================
...
\begin{minipage}[c]{0.68\textwidth}
  ...
  \textbf{\textcolor{NavyBlue}{
    ...
    {\fontsize{16pt}{18pt}\selectfont 2025-26}
  }}
\end{minipage}%
\hfill
% Right image
...
\textbf{Bachelors of Engineering} in \textbf{Computer Engineering} to the \textbf{University of Mumbai}.
\end{spacing}
...
\begin{flushright}
    ...
    \makebox[6cm]{\textbf{Sumit Patil}} \\[0.5cm]
    \rule{6cm}{0.5pt} \\[-0.4cm]
...
\begin{mdframed}
    \centering
    \includegraphics[width=0.91\linewidth,height=0.4\textheight]{placeholder_use_case.png}
\end{mdframed}
