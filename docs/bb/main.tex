...
\large\textbf{\textcolor{red}{PROF. ABHIJEET MORE}} \\[0.4cm]

\includegraphics[width=4cm]{assets/placeholders/phcet_logo.png} \\[0.4cm]

\large\textbf{\textcolor{navy}{DEPARTMENT OF COMPUTER ENGINEERING}} \\[0.2cm]
...
\large\textbf{\textcolor{navy}{RASAYANI, TAL: KHALAPUR, DIST: RAIGAD - 410207}} \\[0.15cm]
\large\textbf{\textcolor{navy}{UNIVERSITY OF MUMBAI}} \\[0.15cm]
...
\vspace{0.1cm}
\begin{center}
\fbox{\includegraphics[width=1\textwidth,height=0.9\textheight]{assets/PlagiarismReport.jpg}}
\end{center}
