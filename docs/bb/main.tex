...
\clearpage
\refstepcounter{chapter}
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Requirement Gathering}
\vspace*{\fill}
\begin{center}
...
\clearpage
\refstepcounter{chapter}
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Plan Of Project}
\vspace*{\fill}
\begin{center}
...
\clearpage
\refstepcounter{chapter}
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Project Analysis}
\vspace*{\fill}
\begin{center}
...
\clearpage
\refstepcounter{chapter}
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Project Design}
\vspace*{\fill}
\begin{center}
...
\clearpage
\refstepcounter{chapter}
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Implemented System}
\vspace*{\fill}
\begin{center}
...
\clearpage
\refstepcounter{chapter}
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Result Analysis}
\vspace*{\fill}
\begin{center}
...
\clearpage
\refstepcounter{chapter}
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Conclusion \& Future Work}
\vspace*{\fill}
\begin{center}
