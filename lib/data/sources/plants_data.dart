...
final List<Plant> plantsData = [
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Eclipta_prostrata_-_False_Daisy_-_Mahananda_Wildlife_Sanctuary_-_West_Bengal_-_India_03.jpg',
    doshas: ['Vata', 'Kapha'],
    ...
    season: ['Monsoon'],
    description:
        "Known as the 'King of Hair', Bhringraj is famous for promoting hair growth and treating liver disorders.",
    uses: [
      'Hair loss',
      'Graying hair',
      'Liver enlargement',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Rauvolfia_serpentina_fruit.jpg',
    doshas: ['Vata', 'Pitta'],
    ...
    season: ['All Seasons'],
    description:
        'Powerful herb for lowering high blood pressure and calming the nervous system. The root resembles a snake.',
    uses: [
      'High blood pressure',
      'Psychosis',
      'Insomnia',
    ...
    precautions:
        'Can cause depression and nasal congestion. Not for long term use.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Andrographis_paniculata.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    description:
        "Known as 'King of Bitters', it is a potent antiviral and liver protective herb. Often called Indian Echinacea.",
    uses: [
      'Liver disorders',
      'Viral fevers',
      'Dengue',
    ...
    precautions:
        'Extremely bitter. May cause gastric irritation in high doses.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Adhatoda_vasica_Nees_Medicinal_Plant_Medicinal_Plant.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    season: ['All Seasons'],
    description:
        'Supreme herb for respiratory system. Helps liquefy sputum and dilate bronchioles.',
    uses: [
      'Chronic cough',
      'Asthma',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Shilajit_exudation.jpg',
    ...
    season: ['Summer'],
    description:
        'Mineral pitch found in Himalayas. Contains fulvic acid and over 84 minerals. Powerful rejuvenator.',
    uses: [
      'General weakness',
      'Sexual health',
      'Diabetes',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Bauhinia_variegata_flower.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    season: ['Spring'],
    description:
        'Beautiful flowering tree. Its bark is the drug of choice for glandular swellings, thyroid, and cysts.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Inula_racemosa.jpg',
    doshas: ['Kapha', 'Vata'],
    ...
    season: ['Autumn'],
    description:
        'Best herb for heart pain (angina) and respiratory blockage. Often used as a substitute for Kuth.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Cyperus_rotundus_flower.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    season: ['All Seasons'],
    description:
        'Excellent digestive and carminative. Specific for treating fevers and female disorders.',
    uses: [
      'IBS',
      'Diarrhea',
      'Fever',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Acacia_catechu_W_IMG_2814.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    season: ['All Seasons'],
    description:
        'Best Ayurvedic herb for skin diseases. Powerful blood purifier and stringyl for gums.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Symplocos_racemosa.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    season: ['Spring'],
    description:
        'Key herb for female gynecological issues. Acts as a uterine tonic and helps stop excessive bleeding.',
    uses: [
      'Leucorrhea',
      'Menorrhagia',
      'Acne',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Crateva_religiosa_leaves.jpg',
    doshas: ['Kapha', 'Vata'],
    ...
    season: ['Spring'],
    description:
        'Top herb for breaking down kidney stones (lithotriptic) and treating urinary tract infections.',
    uses: [
      'Kidney stones',
      'Enlarged prostate',
      'Painful urination',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Achyranthes_aspera.jpg',
    doshas: ['Kapha', 'Vata'],
    ...
    season: ['All Seasons'],
    description:
        'Powerful scraping herb used for weight loss and detoxification. Seeds are used to reduce appetite.',
    uses: [
      'Obesity',
      'Piles/Hemorrhoids',
      'Indigestion',
    ...
    precautions:
        'Avoid in pregnancy (can induce labor). Excessive use causes vomiting.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Vitex_negundo.jpg',
    doshas: ['Vata', 'Kapha'],
    ...
    season: ['All Seasons'],
    description:
        'Potent analgesic and anti-inflammatory. Used extensively in oils for massage to relieve pain.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Nyctanthes_arbortristis_flowers.jpg',
    doshas: ['Kapha', 'Vata'],
    ...
    season: ['Autumn'],
    description:
        'Night flowering jasmine. Its leaves are specific for treating sciatic pain and chronic fevers.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Catharanthus_roseus_%28Madagascar_Periwinkle%29_W_IMG_2270.jpg',
    doshas: ['Kapha', 'Vata'],
    ...
    season: ['All Seasons'],
    description:
        'Periwinkle plant containing alkaloids like vincristine. Traditionally used for diabetes management.',
    uses: [
      'Type 2 Diabetes',
      'Hypertension',
      'Wasp stings',
    ...
    precautions:
        'Potent herb, may cause hypotension. Pregnancy contraindicated.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Phyllanthus_niruri_habit.jpg',
    doshas: ['Pitta', 'Kapha'],
    ...
    season: ['Monsoon'],
    description:
        'Resembles a small amla tree on the ground. World renowned for activity against Hepatitis B virus and liver protection.',
    uses: [
      'Hepatitis B & C',
      'Jaundice',
      'Fatty liver',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Woodfordia_fruticosa.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    season: ['Spring'],
    description:
        'The dried flowers are the fermenting agent in Ayurvedic Arishtams. Also a potent styptic and wound healer.',
    uses: [
      'Dysentery',
      'Bleeding piles',
      'Wounds',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Aconitum_heterophyllum.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    season: ['Summer'],
    description:
        'Safe variety of Aconite used extensively in pediatrics (Bal-rog) for fevers and digestion issues.',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Embelia_ribes.jpg',
    doshas: ['Kapha', 'Vata'],
    ...
    season: ['Winter'],
    description:
        'Best Ayurvedic herb for destroying worms and intestinal parasites. Also an excellent fat burner.',
    uses: [
      'Intestinal worms',
      'Obesity',
      'Skin infections',
  ...
  const Plant(
    ...
    image:
        'https://commons.wikimedia.org/wiki/Special:FilePath/Mimosa_pudica_leaves_closing.jpg',
    doshas: ['Kapha', 'Pitta'],
    ...
    season: ['Monsoon'],
    description:
        'Touch-me-not plant. Excellent for stopping bleeding and shrinking piles mass.',
    uses: [
      'Bleeding piles',
      'Diarrhea',
      'Wounds',
