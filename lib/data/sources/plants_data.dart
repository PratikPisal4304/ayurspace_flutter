...
final List<Plant> plantsData = [
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Eclipta_prostrata_-_False_Daisy_-_Mahananda_Wildlife_Sanctuary_-_West_Bengal_-_India_03.jpg',
    doshas: ['Vata', 'Kapha'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Rauvolfia_serpentina_fruit.jpg',
    doshas: ['Vata', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Andrographis_paniculata.jpg',
    doshas: ['Kapha', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Adhatoda_vasica_Nees_Medicinal_Plant_Medicinal_Plant.jpg',
    doshas: ['Kapha', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Shilajit_exudation.jpg',
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bauhinia_variegata_flower.jpg',
    doshas: ['Kapha', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Inula_racemosa.jpg',
    doshas: ['Kapha', 'Vata'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Cyperus_rotundus_flower.jpg',
    doshas: ['Kapha', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Acacia_catechu_W_IMG_2814.jpg',
    doshas: ['Kapha', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Symplocos_racemosa.jpg',
    doshas: ['Kapha', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Crateva_religiosa_leaves.jpg',
    doshas: ['Kapha', 'Vata'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Achyranthes_aspera.jpg',
    doshas: ['Kapha', 'Vata'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Vitex_negundo.jpg',
    doshas: ['Vata', 'Kapha'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Nyctanthes_arbortristis_flowers.jpg',
    doshas: ['Kapha', 'Vata'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Catharanthus_roseus_%28Madagascar_Periwinkle%29_W_IMG_2270.jpg',
    doshas: ['Kapha', 'Vata'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Phyllanthus_niruri_habit.jpg',
    doshas: ['Pitta', 'Kapha'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Woodfordia_fruticosa.jpg',
    doshas: ['Kapha', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Aconitum_heterophyllum.jpg',
    doshas: ['Kapha', 'Pitta'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Embelia_ribes.jpg',
    doshas: ['Kapha', 'Vata'],
  ...
  const Plant(
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mimosa_pudica_leaves_closing.jpg',
    doshas: ['Kapha', 'Pitta'],
